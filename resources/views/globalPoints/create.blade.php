    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-sm-12 col-md-7">
                <div class="card">
                    <div class="card-header">Dodaj punkt do szablonu: {{$checklist->name}}</div>
                    <div class="card-body" style="margin-left: 3%;">
                        <form id="create-global-point-form" method="post" action="{{ route('globalpoints.store', $checklistId) }}">
                                @csrf
