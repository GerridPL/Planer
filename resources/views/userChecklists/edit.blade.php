        ...
        <div class="card-header">
            <div class="row justify-content ms-1">
                <div class="col-sm-12 col-md-8 col-lg-6 col-xl-5">
                    ...
                    <form id="edit-checklists-form" method="post" action="{{ route('userchecklists.save', $checklist->id) }}">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="sub_exp_date" class="col-11 p-3">
                                Termin
                                <input type="date" class="form-control" name="term" value="{{ $checklist->term }}" tabindex="2"/>
                            </label>
                        </div>
                        <label for="description" class="col-11 p-3">Opis listy konrtolnej
                        ...
                        <div class="m-3">
                            <a href="{{ route('userchecklists.index', $checklist->user) }}" title="Cofnij" type="button" class="btn btn-secondary" tabindex="4">
